...
/*.........................shearphoto专用类................................................注意......文件最后修改时间2015年9月29日..作者：明哥先生.............................. */
...
class zip_img {
	...
	final function __construct($arg) {
		...
		if ($arg["force_jpg"]) {
			...
			$this -> GDfun = array("imagejpeg", ".jpg");
		} else {
		...
		if ($arg["water"]) {
			...
			if ($type == 3) {
				$this -> waterimg = array(imagecreatefrompng($arg["water"]), $W, $H);
			}
		}
	}
	...
	protected function saveimg($createsrc, $save_url, $width, $height) {
		...
		array_push($this -> result, array("ImgUrl" => str_replace(array(ShearURL,$_SERVER['DOCUMENT_ROOT']."/", "\\"), array("","","/"), $save_url), "ImgName" => basename($save_url), "ImgWidth" => $width, "ImgHeight" => $height));
		return $GDW;
	}
